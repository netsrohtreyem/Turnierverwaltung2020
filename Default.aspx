...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
 ...
 <h3>Verfügare Sportarten:</h3>
    ...
    <br />
    <br />
    <asp:Button Visible="false" ID="btnXMLsichern" runat="server" OnClick="btnListespeichern_Click" Text="Liste der Sportarten als XML-Datei downloaden" Font-Bold="True" Font-Size="Medium" />
    <br />
    <br />
    <asp:FileUpload Visible="false" ID="fileupload" runat="server" Font-Bold="True" Font-Size="Medium" />
    <br />
    <asp:Button Visible="false" ID="btnUpload" runat="server" Font-Bold="True" Font-Size="Medium" OnClick="btnListeladen_Click" Text="Liste der Sporarten aus einer XML-Datei hochladen" />
 ...
 <asp:Label ID="lblbezeichnung" runat="server" Font-Bold="True" Font-Size="Medium">Bezeichnung:</asp:Label>&nbsp;&nbsp; &nbsp;<asp:TextBox ID="txtname" runat="server"></asp:TextBox>
    ...
    <br />
    <br />
    <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Änderungen speichern" Font-Bold="True" Enabled="false" />
    &nbsp;&nbsp;&nbsp;&nbsp;
